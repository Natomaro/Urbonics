...
#py.sign_in("natomaro", "d1shwash3r33")

# def data_dump(request):
#     conn = MySQLdb.connect(host="localhost", user="admin", passwd="password", db="world")
#     cursor = conn.cursor()
...
#     py.plot(fig, filename='s3_life-gdp')
#     pio.write_image(fig, 'C:/Users/Class2018/mysite/data/images/fig1.png')
#     return FileResponse(open('C:/Users/Class2018/mysite/data/images/fig1.png','rb'))
