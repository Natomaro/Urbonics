...
def error_doit(hex_input1):
    ...
    Planter_address = int(hex_input1[4:6],16) #Address is h.d. 6-7 (byte 3), value is dec. no.
     #Address is h.d. 8-1 (bytes 4 and 5), ADD A DICTIONARY

    Tag = Tag_Dictionary[int(hex_input1[6:10])]

    #Value = str.decode('d',hex_input1[11:27])
    #Value = hex_input1[11:27]
    #
    Status = Status_dictionary[int(hex_input1[10:12],16)]
    ...
    Date = str(format(int(hex_input1[12:14],16),'02')) + ' ' + Date_Dictionary[int(hex_input1[14:16],16)] + " 20"+str(int(hex_input1[16:18],16))
    Timestamp = str(format(int(hex_input1[18:20],16),'02')) + ":" + str(int(hex_input1[20:22],16)) + ":" + str(int(hex_input1[22:],16))
